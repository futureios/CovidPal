...
class MainVC: ESTabBarController {
    ...
    override func viewDidLoad() {
        ...
        let v2 = self.storyboard?.instantiateViewController(withIdentifier: "ProfileVC") as! ProfileVC
        ...
        v2.tabBarItem = ESTabBarItem.init(ExampleBasicContentView(), title: "Profile", image: #imageLiteral(resourceName: "users"), selectedImage: #imageLiteral(resourceName: "user-filled"))
